package com.example.base_shopping.autowired;

import com.example.base_shopping.AutoAppConfig;
...
public class AllBeanTest {
    ...
    void findAllBean(){
        ...
        int rateDiscountPrice = discountService.discount(member, 10000, "percentDiscountPolicy");
